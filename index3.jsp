...
<body>
    <h1 style="text-align:center">Men's FootWear SHOP </h1>
      ...
      <div id="site">
        <div class="container">
          ...
          <div class="row">
            ...
            <h3>Shoes</h3>
            <div class="product-description" data-name="Shoes" data-price="100">
            ...
            <div class="product-bottom text-center">
              <span class="fa fa-star checked"></span>
                ...
                <span class="fa fa-star"></span>
            <h3>Shoes-1</h3>
            <div class="product-description" data-name="Shoes-1" data-price="150">
            ...
            <div class="row">
              ...
              <div class="product-bottom text-center">
                ...
                <span class="fa fa-star"></span>
              <h3>Bruton Shoes</h3>
              <div class="product-description" data-name="Bruton Shoes" data-price="250">
            ...
            <div class="row">
              ...
              <div class="product-bottom text-center">
                ...
                <span class="fa fa-star checked"></span>
                <span class="fa fa-star"></span>
              <h3>Woodland for Men's</h3>
              <div class="product-description" data-name="Men's Floaters" data-price="170">
